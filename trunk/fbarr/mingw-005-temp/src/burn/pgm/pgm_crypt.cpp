...
static const unsigned char kovshp_tab[256] = { // IGS0009 rd1040
...
static const unsigned char qmlw_tab[256] = { // IGS0013 RD
...
static const unsigned char kbex_tab[] = { // IGS0024
...
void pgm_decrypt_killbldp()
{
	...
	for (int i = 0; i< 0x800000/2; i++) {
		...
		x ^= kbex_tab[(i >> 1) & 0xff] << 8;

		src[i] = x;
	}
}

static const unsigned char happy6in1_tab[256] = { 
