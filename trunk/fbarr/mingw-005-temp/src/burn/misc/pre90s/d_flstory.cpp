...
struct BurnDriver BurnDrvFlstory = {
	...
	flstoryInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvOnna34ro = {
	...
	onna34roInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvVictnine = {
	...
	victnineInit, DrvExit, DrvFrame, victnineDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x200,
	256, 224, 4, 3
};
