...
struct BurnDriver BurnDrvSrumbler = {
	...
	NULL, srumblerRomInfo, srumblerRomName, SrumblerInputInfo, SrumblerDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvSrumblr2 = {
	...
	NULL, srumblr2RomInfo, srumblr2RomName, SrumblerInputInfo, SrumblerDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL,
	&DrvRecalc, 0x200, 240, 352, 3, 4
};
...
struct BurnDriver BurnDrvRushcrsh = {
	"rushcrsh", "srumbler", NULL, "1986",
	"Rush & Crash (Japan)\0", NULL, "Capcom", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	NULL, rushcrshRomInfo, rushcrshRomName, SrumblerInputInfo, SrumblerDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL,
	&DrvRecalc, 0x200, 240, 352, 3, 4
};
