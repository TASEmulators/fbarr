...
//	}
	...
	if (nMenuUITheme > 0) {
		switch (nMenuUITheme) {
			...
			case 3: {
				var = MENU_OFFICETHEME;
				break;
			}

			case 4: {
				var = MENU_OFFICE2003THEME;
				break;
			}

			case 5: {
				var = MENU_OFFICE2007THEME;
				break;
			}

			case 6: {
				var = MENU_VISSTUDIOEXTHEME;
				break;
			}
		}
	}
	...
	CheckMenuItem(hMenu, MENU_AUTOSUPPORTDOWNLOAD, bEnableAutoSupportFileDownload ? MF_CHECKED : MF_UNCHECKED);
