...
struct BurnDriver BurnDrvGrdians = {
	...
	grdiansInit, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	304, 232, 4, 3
};
...
struct BurnDriver BurnDrvMj4simai = {
	...
	mj4simaiInit, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvMyangel = {
	...
	myangelInit, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	376, 240, 4, 3
};
...
struct BurnDriver BurnDrvMyangel2 = {
	...
	myangel2Init, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	376, 240, 4, 3
};
...
struct BurnDriver BurnDrvPzlbowl = {
	...
	pzlbowlInit, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvPenbros = {
	...
	penbrosInit, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 224, 4, 3
};

struct BurnDriver BurnDrvGundamex = {
	"gundamex", NULL, NULL, "1994",
	"Mobile Suit Gundam EX Revue\0", NULL, "Banpresto", "Newer Seta",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_VSFIGHT, 0,
	NULL, gundamexRomInfo, gundamexRomName, GundamexInputInfo, GundamexDIPInfo,
	gundamexInit, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	384, 224, 4, 3
};

struct BurnDriver BurnDrvDeerhunt = {
	"deerhunt", NULL, NULL, "2000",
	"Deer Hunting USA V4.3\0", NULL, "Sammy USA Corporation", "Newer Seta",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	NULL, deerhuntRomInfo, deerhuntRomName, DeerhuntInputInfo, DeerhuntDIPInfo,
	samshootInit, grdiansExit, samshootFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvDeerhuna = {
	"deerhunta", "deerhunt", NULL, "2000",
	...
	NULL, deerhunaRomInfo, deerhunaRomName, DeerhuntInputInfo, DeerhuntDIPInfo,
	samshootInit, grdiansExit, samshootFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvDeerhunb = {
	"deerhuntb", "deerhunt", NULL, "2000",
	"Deer Hunting USA V4.0\0", NULL, "Sammy USA Corporation", "Newer Seta",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 1, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	NULL, deerhunbRomInfo, deerhunbRomName, DeerhuntInputInfo, DeerhuntDIPInfo,
	samshootInit, grdiansExit, samshootFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvDeerhunc = {
	"deerhuntc", "deerhunt", NULL, "2000",
	"Deer Hunting USA V2\0", NULL, "Sammy USA Corporation", "Newer Seta",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 1, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	NULL, deerhuncRomInfo, deerhuncRomName, DeerhuntInputInfo, DeerhuntDIPInfo,
	samshootInit, grdiansExit, samshootFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvTurkhunt = {
	"turkhunt", NULL, NULL, "2001",
	"Turkey Hunting USA V1.0\0", NULL, "Sammy USA Corporation", "Newer Seta",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	NULL, turkhuntRomInfo, turkhuntRomName, DeerhuntInputInfo, TurkhuntDIPInfo,
	samshootInit, grdiansExit, samshootFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvWschamp = {
	"wschamp", NULL, NULL, "2001",
	"Wing Shooting Championship V2.00\0", NULL, "Sammy USA Corporation", "Newer Seta",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	NULL, wschampRomInfo, wschampRomName, WschampInputInfo, WschampDIPInfo,
	samshootInit, grdiansExit, samshootFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvWschampa = {
	"wschampa", "wschamp", NULL, "2001",
	...
	NULL, wschampaRomInfo, wschampaRomName, WschampInputInfo, WschampDIPInfo,
	samshootInit, grdiansExit, samshootFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvTrophyh = {
	"trophyh", NULL, NULL, "2002",
	"Trophy Hunting - Bear & Moose V1.0\0", NULL, "Sammy USA Corporation", "Newer Seta",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	NULL, trophyhRomInfo, trophyhRomName, WschampInputInfo, TrophyhDIPInfo,
	samshootInit, grdiansExit, samshootFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};
...
struct BurnDriverD BurnDrvFuncube2 = {
	"funcube2", NULL, NULL, "2001",
	"Funcube 2 (v1.1)\0", "Unemulated Sub CPU", "Namco", "Newer Seta",
	NULL, NULL, NULL, NULL,
	0, 2, HARDWARE_MISC_POST90S, GBF_PUZZLE, 0,
	NULL, funcube2RomInfo, funcube2RomName, grdiansInputInfo, grdiansDIPInfo,
	funcubeInit, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};

struct BurnDriverD BurnDrvFuncube4 = {
	"funcube4", NULL, NULL, "2001",
	"Funcube 4 (v1.0)\0", "Unemulated Sub CPU", "Namco", "Newer Seta",
	NULL, NULL, NULL, NULL,
	0, 2, HARDWARE_MISC_POST90S, GBF_PUZZLE, 0,
	NULL, funcube4RomInfo, funcube4RomName, grdiansInputInfo, grdiansDIPInfo,
	funcubeInit, grdiansExit, grdiansFrame, NULL, grdiansScan, 0, NULL, NULL, NULL, &bRecalcPalette, 0x8000,
	320, 240, 4, 3
};
