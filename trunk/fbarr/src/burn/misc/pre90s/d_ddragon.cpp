...
static int DdungeonLoadRoms()
{
	...
	// Load samples
	nRet = BurnLoadRom(MSM5205ROM + 0x00000, 10, 1); if (nRet != 0) return 1;
	nRet = BurnLoadRom(MSM5205ROM + 0x10000, 11, 1); if (nRet != 0) return 1;
...
struct BurnDriver BurnDrvDdragon = {
	...
	0, NULL, NULL, NULL, NULL, 0x180, 256, 240, 4, 3
};
...
struct BurnDriver BurnDrvDdungeon = {
	"ddungeon", NULL, NULL, "1992",
	"Dangerous Dungeons\0", NULL, "Game Room", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	NULL, DdungeonRomInfo, DdungeonRomName, DrvInputInfo, DdungeonDIPInfo,
	DdungeonInit, DrvExit, DrvFrame, NULL, DrvScan,
	0, NULL, NULL, NULL, NULL, 0x180, 256, 240, 4, 3
};

struct BurnDriver BurnDrvDarktowr = {
	"darktowr", NULL, NULL, "1992",
	"Dark Tower\0", NULL, "Game Room", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	NULL, DarktowrRomInfo, DarktowrRomName, DrvInputInfo, DarktowrDIPInfo,
