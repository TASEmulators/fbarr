...
// Return of the Invaders (bootleg set 3)

static struct BurnRomInfo retofin3RomDesc[] = {
	{ "1.11",	0x2000, 0x71C216CA, 1 | BRF_PRG | BRF_ESS }, //  0 Z80 #0 Code
	{ "3.9",	0x2000, 0x92D79FA8, 1 | BRF_PRG | BRF_ESS }, //  1
	{ "ri-a.1c",	0x2000, 0x3ae7c530, 1 | BRF_PRG | BRF_ESS }, //  2
	...
	{ "74s287.b",   0x0100, 0xdd2f499a, 7 | BRF_GRA },	     // 12 Color Proms
//	{ "a37-06.13",	0x0100, 0xe9643b8b, 7 | BRF_GRA },           // 12 Color Proms
	{ "a37-07.4",	0x0100, 0xe8f34e11, 7 | BRF_GRA },           // 13
	{ "a37-08.3",	0x0100, 0x50030af0, 7 | BRF_GRA },           // 14
	// these have the same data as 82s191n, just in a different format.
	{ "6353-1.a",   0x0400, 0xc63cf10e, 7 | BRF_GRA }, 	     // 15 - high nibble
	{ "6353-1.b",   0x0400, 0x6db07bd1, 7 | BRF_GRA }, 	     // 16 - low nibble
	{ "6353-1.c",   0x0400, 0x77a7aaf6, 7 | BRF_GRA }, 	     // 17 - high nibble
	{ "6353-1.d",   0x0400, 0xa92aea27, 7 | BRF_GRA }, 	     // 18 - low nibble
};

STD_ROM_PICK(retofin3)
STD_ROM_FN(retofin3)

struct BurnDriver BurnDrvRetofin3 = {
	"retofin3", "retofinv", NULL, "1985",
	"Return of the Invaders (bootleg set 3)\0", NULL, "bootleg", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	NULL, retofin3RomInfo, retofin3RomName, RetofinvInputInfo, RetofinvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0xa00,
	224, 288, 3, 4
};
