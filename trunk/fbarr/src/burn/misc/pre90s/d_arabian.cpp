...
static struct BurnRomInfo arabianRomDesc[] = {
	...
	{ "ic84.91",    0x2000, 0xc4637822, BRF_GRA },		 //  4 Graphics
	{ "ic85.92",    0x2000, 0xf7c6866d, BRF_GRA },		 //  5
	{ "ic86.93",    0x2000, 0x71acd48d, BRF_GRA },		 //  6
	{ "ic87.94",    0x2000, 0x82160b9a, BRF_GRA },		 //  7
};
...
struct BurnDriver BurnDrvarabian = {
	...
	NULL, arabianRomInfo, arabianRomName, ArabianInputInfo, ArabianDIPInfo,
...
static struct BurnRomInfo arabianaRomDesc[] = {
	{ "ic1.87",     0x2000, 0x51e9a6b1, BRF_ESS | BRF_PRG }, //  0 Z80 Code
	{ "ic2.88",     0x2000, 0x1cdcc1ab, BRF_ESS | BRF_PRG }, //  1
	{ "ic3.89",     0x2000, 0xb7b7faa0, BRF_ESS | BRF_PRG }, //  2
	{ "ic4.90",     0x2000, 0xdbded961, BRF_ESS | BRF_PRG }, //  3
...
struct BurnDriver BurnDrvarabiana = {
	...
	NULL, arabianaRomInfo, arabianaRomName, ArabianInputInfo, ArabianaDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x2000,
	234, 256, 3, 4
};
