...
struct BurnDriver BurnDrvToki = {
	...
	NULL, tokiRomInfo, tokiRomName, TokiInputInfo, TokiDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, NULL, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvTokia = {
	"tokia", "toki", NULL, "1989",
	"Toki (World set 2)\0", NULL, "Tad", "hardware",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	NULL, tokiaRomInfo, tokiaRomName, TokiInputInfo, TokiDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, NULL, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvTokiu = {
	"tokiu", "toki", NULL, "1989",
	"Toki (US)\0", NULL, "Tad (Fabtek license)", "hardware",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	NULL, tokiuRomInfo, tokiuRomName, TokiInputInfo, TokiDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, NULL, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvJuju = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	NULL, jujuRomInfo, jujuRomName, TokiInputInfo, TokiDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, NULL, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvJujub = {
	"jujub", "toki", NULL, "1989",
	"JuJu Densetsu (Japan, bootleg)\0", NULL, "bootleg", "hardware",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	NULL, jujubRomInfo, jujubRomName, TokiInputInfo, TokiDIPInfo,
	JujubInit, DrvExit, DrvFrame, DrvDraw, NULL, 0, NULL, NULL, NULL, NULL, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriverD BurnDrvTokib = {
	"tokib", "toki", NULL, "1989",
	"Toki (bootleg)\0", NULL, "bootleg", "hardware",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	NULL, tokibRomInfo, tokibRomName, TokibInputInfo, TokibDIPInfo,
	TokibInit, DrvExit, TokibFrame, TokibDraw, NULL, 0, NULL, NULL, NULL, NULL, 0x400,
	256, 224, 4, 3
};
