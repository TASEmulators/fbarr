...
static inline void draw_sprite_line(int wide, UINT16* dest, UINT8 *pdest, int xzoom, int xgrow, int yoffset, int flip, int xpos, int prio)
{
	int xzoombit;
	int xoffset;
