...
struct BurnDriver BurnDrvDevilw = {
	...
	devilwInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvVulcan = {
	...
	vulcanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvGradius2 = {
	...
	gradius2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvFround = {
	...
	froundInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvHpuncher = {
	...
	hpuncherInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvMiaj = {
	...
	miajInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvCuebrckj = {
	...
	cuebrckjInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
