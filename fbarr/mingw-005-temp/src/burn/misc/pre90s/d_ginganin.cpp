...
struct BurnDriver BurnDrvGinganin = {
	...
	NULL, ginganinRomInfo, ginganinRomName, GinganinInputInfo, GinganinDIPInfo,
...
struct BurnDriver BurnDrvGinganina = {
	...
	NULL, ginganinaRomInfo, ginganinaRomName, GinganinInputInfo, GinganinDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	256, 224, 4, 3
};
