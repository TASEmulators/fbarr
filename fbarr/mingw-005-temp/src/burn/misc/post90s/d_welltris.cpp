...
static struct BurnDIPInfo WelltrisDIPList[]=
{
	...
	{0x25, 0xff, 0xff, 0xfb, NULL				},

	{0   , 0xfe, 0   ,   16, "Coin A"			},
	{0x24, 0x01, 0x0f, 0x06, "5 Coins 1 Credits"		},
	{0x24, 0x01, 0x0f, 0x07, "4 Coins 1 Credits"		},
	{0x24, 0x01, 0x0f, 0x08, "3 Coins 1 Credits"		},
	{0x24, 0x01, 0x0f, 0x09, "2 Coins 1 Credits"		},
	{0x24, 0x01, 0x0f, 0x04, "2-1, 4-2, 5-3, 6-4"		},
	{0x24, 0x01, 0x0f, 0x03, "2-1, 4-3"			},
	{0x24, 0x01, 0x0f, 0x0f, "1 Coin  1 Credits"		},
	{0x24, 0x01, 0x0f, 0x01, "1-1, 2-2, 3-3, 4-5"		},
	{0x24, 0x01, 0x0f, 0x02, "1-1, 2-2, 3-3, 4-4, 5-6"	},
	{0x24, 0x01, 0x0f, 0x00, "1-1, 2-3"			},
	{0x24, 0x01, 0x0f, 0x05, "2 Coins 3 Credits"		},
	{0x24, 0x01, 0x0f, 0x0e, "1 Coin  2 Credits"		},
	{0x24, 0x01, 0x0f, 0x0d, "1 Coin  3 Credits"		},
	{0x24, 0x01, 0x0f, 0x0c, "1 Coin  4 Credits"		},
	{0x24, 0x01, 0x0f, 0x0b, "1 Coin  5 Credits"		},
	{0x24, 0x01, 0x0f, 0x0a, "1 Coin  6 Credits"		},

	{0   , 0xfe, 0   ,   16, "Coin B"			},
	{0x24, 0x01, 0xf0, 0x60, "5 Coins 1 Credits"		},
	{0x24, 0x01, 0xf0, 0x70, "4 Coins 1 Credits"		},
	{0x24, 0x01, 0xf0, 0x80, "3 Coins 1 Credits"		},
	{0x24, 0x01, 0xf0, 0x90, "2 Coins 1 Credits"		},
	{0x24, 0x01, 0xf0, 0x40, "2-1, 4-2, 5-3, 6-4"		},
	{0x24, 0x01, 0xf0, 0x30, "2-1, 4-3"			},
	{0x24, 0x01, 0xf0, 0xf0, "1 Coin  1 Credits"		},
	{0x24, 0x01, 0xf0, 0x10, "1-1, 2-2, 3-3, 4-5"		},
	{0x24, 0x01, 0xf0, 0x20, "1-1, 2-2, 3-3, 4-4, 5-6"	},
	{0x24, 0x01, 0xf0, 0x00, "1-1, 2-3"			},
	{0x24, 0x01, 0xf0, 0x50, "2 Coins 3 Credits"		},
	{0x24, 0x01, 0xf0, 0xe0, "1 Coin  2 Credits"		},
	{0x24, 0x01, 0xf0, 0xd0, "1 Coin  3 Credits"		},
	{0x24, 0x01, 0xf0, 0xc0, "1 Coin  4 Credits"		},
	{0x24, 0x01, 0xf0, 0xb0, "1 Coin  5 Credits"		},
	{0x24, 0x01, 0xf0, 0xa0, "1 Coin  6 Credits"		},

	{0   , 0xfe, 0   ,    4, "Difficulty"			},
	{0x25, 0x01, 0x03, 0x02, "Easy"				},
	{0x25, 0x01, 0x03, 0x03, "Normal"			},
	{0x25, 0x01, 0x03, 0x01, "Hard"				},
	{0x25, 0x01, 0x03, 0x00, "Hardest"			},

	{0   , 0xfe, 0   ,    2, "Coin Mode"			},
	{0x25, 0x01, 0x04, 0x04, "Mono Player"			},
	{0x25, 0x01, 0x04, 0x00, "Many Player"			},
...
//	{0x25, 0x01, 0x10, 0x10, "Off"				},
//	{0x25, 0x01, 0x10, 0x00, "On"				},

	{0   , 0xfe, 0   ,    2, "4 Players Mode"		},
	{0x25, 0x01, 0x30, 0x30, "Off"				},
	{0x25, 0x01, 0x30, 0x00, "On"				},
...
struct BurnDriver BurnDrvWelltris = {
	"welltris", NULL, NULL, "1991",
	"Welltris (World?, 2 players)\0", NULL, "Video System Co.", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 4, HARDWARE_MISC_POST90S, GBF_PUZZLE, 0,
	NULL, welltrisRomInfo, welltrisRomName, WelltrisInputInfo, WelltrisDIPInfo,
...
struct BurnDriver BurnDrvWelltrisj = {
	"welltrisj", "welltris", NULL, "1991",
	"Welltris (Japan, 2 players)\0", NULL, "Video System Co.", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_MISC_POST90S, GBF_PUZZLE, 0,
	NULL, welltrisjRomInfo, welltrisjRomName, WelltrisInputInfo, WelltrisDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x800,
	352, 240, 4, 3
};
