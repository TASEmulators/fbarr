...
void __fastcall cadash_sound_write(unsigned short a, unsigned char d)
{
	switch (a)
	{
		...
		case 0xb000: // asuka (msm5205_address_w)
		case 0xc000: // asuka (msm5205_start_w)
		case 0xd000: // asuka (msm5205_stop_w)
		return;
	}
}
...
static void Eto68KSetup()
{
	...
	SekMapMemory(TC0100SCNRam[0] + 0x4000,	0xc04000, 0xc0ffff, SM_RAM); // mirror
...
static int CommonInit(void (*Cpu68KSetup)(), void (*CpuZ80Setup)(), void (*SoundSetup)(), int buffer_sprites)
{
	...
	TC0100SCNInit(1, (0x80000 * 2) / 0x40, 0, (256 - nScreenHeight) / 2, 0, NULL);
...
static int DrvScan(int nAction,int *pnMin)
{
	...
	//	if (TaitoNumMSM5205) MSM5205Scan(0, nAction);
...
struct BurnDriver BurnDrvCadash = {
	"cadash", NULL, NULL, "1989",
	"Cadash (World)\0", NULL, "Taito Corporation Japan", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_TAITO_MISC, GBF_SCRFIGHT, 0,
	NULL, cadashRomInfo, cadashRomName, CadashInputInfo, CadashDIPInfo,
	CadashInit, TaitoExit, CadashFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCadashu = {
	"cadashu", "cadash", NULL, "1989",
	"Cadash (US)\0", NULL, "Taito America Corporation", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC, GBF_SCRFIGHT, 0,
	NULL, cadashuRomInfo, cadashuRomName, CadashInputInfo, CadashuDIPInfo,
	CadashInit, TaitoExit, CadashFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCadashi = {
	"cadashi", "cadash", NULL, "1989",
	"Cadash (Italy)\0", NULL, "Taito Corporation Japan", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC, GBF_SCRFIGHT, 0,
	NULL, cadashiRomInfo, cadashiRomName, CadashInputInfo, CadashDIPInfo,
	CadashInit, TaitoExit, CadashFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCadashf = {
	"cadashf", "cadash", NULL, "1989",
	"Cadash (France)\0", NULL, "Taito Corporation Japan", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC, GBF_SCRFIGHT, 0,
	NULL, cadashfRomInfo, cadashfRomName, CadashInputInfo, CadashDIPInfo,
	CadashInit, TaitoExit, CadashFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCadashg = {
	"cadashg", "cadash", NULL, "1989",
	"Cadash (Germany)\0", NULL, "Taito Corporation Japan", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC, GBF_SCRFIGHT, 0,
	NULL, cadashgRomInfo, cadashgRomName, CadashInputInfo, CadashDIPInfo,
	CadashInit, TaitoExit, CadashFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvEto = {
	...
	NULL, etoRomInfo, etoRomName, AsukaInputInfo, EtoDIPInfo,
	EtoInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvAsuka = {
	"asuka", NULL, NULL, "1988",
	"Asuka & Asuka (World)\0", "Missing MSM5205 sound", "Taito Corporation", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_TAITO_MISC, GBF_VERSHOOT, 0,
	NULL, asukaRomInfo, asukaRomName, AsukaInputInfo, AsukaDIPInfo,
	AsukaInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvAsukaj = {
	"asukaj", "asuka", NULL, "1988",
	"Asuka & Asuka (Japan)\0", "Missing MSM5205 sound", "Taito Corporation", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_TAITO_MISC, GBF_VERSHOOT, 0,
	NULL, asukajRomInfo, asukajRomName, AsukaInputInfo, AsukaDIPInfo,
	AsukaInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvMofflott = {
	"mofflott", NULL, NULL, "1989",
	"Maze of Flott (Japan)\0", "Missing MSM5205 sound", "Taito Corporation", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_TAITO_MISC, GBF_MAZE, 0,
	NULL, mofflottRomInfo, mofflottRomName, AsukaInputInfo, MofflottDIPInfo,
	AsukaInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvGalmedes = {
	"galmedes", NULL, NULL, "1992",
	"Galmedes (Japan)\0", NULL, "Visco", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_TAITO_MISC, GBF_VERSHOOT, 0,
	NULL, galmedesRomInfo, galmedesRomName, AsukaInputInfo, GalmedesDIPInfo,
	GalmedesInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvEarthjkr = {
	"earthjkr", NULL, NULL, "1993",
	"U.N. Defense Force: Earth Joker\0", NULL, "Visco", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_TAITO_MISC, GBF_VERSHOOT, 0,
	NULL, earthjkrRomInfo, earthjkrRomName, AsukaInputInfo, EarthjkrDIPInfo,
	GalmedesInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBonzeadv = {
	...
	NULL, bonzeadvRomInfo, bonzeadvRomName, BonzeadvInputInfo, BonzeadvDIPInfo,
	BonzeInit, TaitoExit, BonzeFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvBonzeadvo = {
	...
	NULL, bonzeadvoRomInfo, bonzeadvoRomName, BonzeadvInputInfo, BonzeadvDIPInfo,
	BonzeInit, TaitoExit, BonzeFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvBonzeadvu = {
	"bonzeadvu", "bonzeadv", NULL, "1988",
	"Bonze Adventure (US)\0", NULL, "Taito America Corporation", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC, GBF_PLATFORM, 0,
	NULL, bonzeadvuRomInfo, bonzeadvuRomName, BonzeadvInputInfo, JigkmgriDIPInfo,
	BonzeInit, TaitoExit, BonzeFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x1000,
	320, 224, 4, 3
};
