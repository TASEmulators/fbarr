...
struct BurnDriver BurnDrvWwfsstar = {
	"wwfsstar", NULL, NULL, "1989",
	"WWF Superstars (Europe)\0", NULL, "Technos Japan", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_VSFIGHT, 0,
	NULL, wwfsstarRomInfo, wwfsstarRomName, WwfsstarInputInfo, WwfsstarDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x180,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvWwfsstara = {
	"wwfsstara", "wwfsstar", NULL, "1989",
	"WWF Superstars (US, Newer)\0", NULL, "Technos Japan", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_VSFIGHT, 0,
	NULL, wwfsstaraRomInfo, wwfsstaraRomName, WwfsstarInputInfo, WwfsstarDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, NULL, 0x180,
	256, 240, 4, 3
};
