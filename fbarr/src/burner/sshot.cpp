...
int MakeScreenShot()
{
    ...
    sprintf(szSShotName,"%s%s%s-%.2d-%.2d-%.2d%.2d%.2d.png", _TtoA(szCurrentPath), SSHOT_DIRECTORY, BurnDrvGetTextA(DRV_NAME), tmTime->tm_mon + 1, tmTime->tm_mday, tmTime->tm_hour, tmTime->tm_min, tmTime->tm_sec);
