...
struct BurnDriver BurnDrvBlock = {
	...
	NULL, BlockRomInfo, BlockRomName, BlockInputInfo, NULL,
	BlockInit, DrvExit, DrvFrame, NULL, DrvScan,
	0, NULL, NULL, NULL, NULL, 0x800, 240, 384, 3, 4
};

struct BurnDriver BurnDrvBlockj = {
	"blockj", "block", NULL, "1991",
...
struct BurnDriver BurnDrvBlockbl = {
	...
	NULL, BlockblRomInfo, BlockblRomName, BlockInputInfo, NULL,
