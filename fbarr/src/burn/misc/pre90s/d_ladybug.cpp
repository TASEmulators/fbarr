...
struct BurnDriver BurnDrvLadybug = {
	...
	NULL, ladybugRomInfo, ladybugRomName, LadybugInputInfo, LadybugDIPInfo,
	LadybugInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x60,
	196, 240, 3, 4
};
...
struct BurnDriver BurnDrvLadybugb = {
	...
	NULL, ladybugbRomInfo, ladybugbRomName, LadybugInputInfo, LadybugDIPInfo,
	LadybugInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x60,
	196, 240, 3, 4
};
...
struct BurnDriver BurnDrvLadybgb2 = {
	"ladybgb2", "ladybug", NULL, "1981",
	"Lady Bug (bootleg set 2)\0", NULL, "bootleg", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	NULL, ladybgb2RomInfo, ladybgb2RomName, LadybugInputInfo, LadybugDIPInfo,
	LadybugInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x60,
	196, 240, 3, 4
};
...
struct BurnDriver BurnDrvSnapjack = {
	"snapjack", NULL, NULL, "1982",
	"Snap Jack\0", NULL, "Universal", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	NULL, snapjackRomInfo, snapjackRomName, LadybugInputInfo, SnapjackDIPInfo,
	LadybugInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x60,
	240, 196, 4, 3
};
...
struct BurnDriver BurnDrvCavenger = {
	"cavenger", NULL, NULL, "1981",
	"Cosmic Avenger\0", NULL, "Universal", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	NULL, cavengerRomInfo, cavengerRomName, LadybugInputInfo, CavengerDIPInfo,
	CavengerInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x60,
	240, 196, 4, 3
};
...
struct BurnDriver BurnDrvDorodon = {
	"dorodon", NULL, NULL, "1982",
	"Dorodon (set 1)\0", NULL, "Falcon", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	NULL, dorodonRomInfo, dorodonRomName, LadybugInputInfo, DorodonDIPInfo,
	DorodonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x60,
	196, 240, 3, 4
};
...
struct BurnDriver BurnDrvDorodon2 = {
	"dorodon2", "dorodon", NULL, "1982",
	"Dorodon (set 2)\0", NULL, "Falcon", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	NULL, dorodon2RomInfo, dorodon2RomName, LadybugInputInfo, DorodonDIPInfo,
	DorodonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x60,
	196, 240, 3, 4
};
...
struct BurnDriver BurnDrvSraider = {
	...
	NULL, sraiderRomInfo, sraiderRomName, SraiderInputInfo, SraiderDIPInfo,
	SraiderInit, DrvExit, SraiderFrame, SraiderDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x82,
	196, 240, 3, 4
};
