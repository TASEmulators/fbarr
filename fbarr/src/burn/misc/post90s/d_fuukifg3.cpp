...
struct BurnDriver BurnDrvAsurabld = {
	"asurabld", NULL, NULL, "1998",
	"Asura Blade - Sword of Dynasty (Japan)\0", "Imperfect GFX", "Fuuki", "FG-3",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_VSFIGHT, 0,
	NULL, asurabldRomInfo, asurabldRomName, AsurabldInputInfo, AsurabldDIPInfo,
...
struct BurnDriver BurnDrvAsurabus = {
	...
	NULL, asurabusRomInfo, asurabusRomName, AsurabldInputInfo, AsurabldDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc,
	320, 240, 4, 3
};
