// This file was generated by C:\msys\1.0\home\Mike\fba\src\scripts\gamelist.pl (perl 5.006001)
...
DRV		BurnDrvMDalex;			// no comment [NOT WORKING]
#endif
DRV		BurnDrvAlexkid1;
DRV		BurnDrvAlexkidd;
DRV		BurnDrvalibaba;
...
DRV		BurnDrvAltbeast;
#if defined FBA_DEBUG
DRV		BurnDrvMDabea;			// no comment [NOT WORKING]
#endif
DRV		BurnDrvambush;
DRV		BurnDrvambusht;
DRV		BurnDrvambushv;
#if defined FBA_DEBUG
DRV		BurnDrvMDagla;			// no comment [NOT WORKING]
...
DRV		BurnDrvMDbttf;			// no comment [NOT WORKING]
...
DRV		BurnDrvMDbatf;			// no comment [NOT WORKING]
...
DRV		BurnDrvBgaregt2;
#if defined FBA_DEBUG
DRV		BurnDrvMDbglf;			// no comment [NOT WORKING]
#endif
DRV		BurnDrvBtlKRoad;
DRV		BurnDrvMDbtlm;
DRV		BurnDrvMDbtl2;
...
DRV		BurnDrvMDbloc;
#if defined FBA_DEBUG
DRV		BurnDrvMDblocb2;		// no comment [NOT WORKING]
...
DRV		BurnDrvMDbody;			// no comment [NOT WORKING]
#endif
DRV		BurnDrvBodyslam;
DRV		BurnDrvBombjack;
DRV		BurnDrvBombjac2;
...
DRV		BurnDrvMDbubs;
#if defined FBA_DEBUG
DRV		BurnDrvMDbuck;			// no comment [NOT WORKING]
#endif
DRV		BurnDrvMDbudoe;
DRV		BurnDrvMDbudo;
DRV		BurnDrvMDbbny;
...
DRV		BurnDrvfunkbeeb;
#if defined FBA_DEBUG
DRV		BurnDrvfnkyfish;		// no comment
...
DRV		BurnDrvkangaroo;		// no comment
DRV		BurnDrvkangaroa;		// no comment
DRV		BurnDrvkangarob;		// no comment
#endif
DRV		BurnDrvKaratblj;
DRV		BurnDrvKaratblu;
DRV		BurnDrvKaratblz;
...
DRV		BurnDrvMDg_2020;		// no comment [NOT WORKING]
...
static struct BurnDriver* pDriver[] = {
	...
	&BurnDrvMDabz2,				// Aerobiz Supersonic (U) [!] [no comment, NOT WORKING]
	...
	&BurnDrvMDalex,				// Alex Kidd in the Enchanted Castle (U) [!] [no comment, NOT WORKING]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvMDabea,				// Altered Beast (UE) (REV02) [!] [no comment, NOT WORKING]
#endif
	&BurnDrvambush,				// Ambush
	&BurnDrvambusht,			// Ambush (Tecfri)
	&BurnDrvambushv,			// Ambush (Volt Elec co-ltd)
#if defined FBA_DEBUG
	&BurnDrvMDagla,				// American Gladiators (U) [!] [no comment, NOT WORKING]
	...
	&BurnDrvMDbttf,				// Back to the Future Part III (U) [!] [no comment, NOT WORKING]
	...
	&BurnDrvMDbatf,				// Batman Forever (W) [!] [no comment, NOT WORKING]
...
#if defined FBA_DEBUG
	&BurnDrvMDbglf,				// Battle Golfer Yui (J) [c][!] [no comment, NOT WORKING]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvMDblocb2,			// Blockbuster World Video Game Championship II (U) [no comment, NOT WORKING]
	...
	&BurnDrvMDbody,				// Body Count (E) (M5) [!] [no comment, NOT WORKING]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvMDbuck,				// Buck Rogers - Countdown to Doomsday (UE) [!] [no comment, NOT WORKING]
#endif
...
#endif
	&BurnDrvCpsDaimakr2,		// Dai Makai-Mura (Japan hack?)
...
#if defined FBA_DEBUG
	&BurnDrvfnkyfish,			// Funky Fish [no comment]
	...
	&BurnDrvJojo,				// JoJo's Venture / JoJo no Kimyouna Bouken (Japan 981202)
	&BurnDrvJojoalt,			// JoJo's Venture / JoJo no Kimyouna Bouken (Japan 990108)
	...
	&BurnDrvkangaroo,			// Kangaroo [no comment]
	&BurnDrvkangaroa,			// Kangaroo (Atari) [no comment]
	&BurnDrvkangarob,			// Kangaroo (bootleg) [no comment]
#endif
	...
	&BurnDrvSfiii2u,			// Street Fighter III 2nd Impact: Giant Attack (USA 970930)
	...
	&BurnDrvSfiii3a,			// Street Fighter III 3rd Strike: Fight for the Future (USA 990608)
	...
	&BurnDrvMDg_2020,			// Super Baseball 2020 (UE) [!] [no comment, NOT WORKING]
